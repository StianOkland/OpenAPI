(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('singleline')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'singleline'], factory) :
  (global = global || self, factory(global['react-responsive-select'] = {}, global.React, global.singleline));
}(this, (function (exports, React, singleline) { 'use strict';

  var React__default = 'default' in React ? React['default'] : React;
  singleline = singleline && Object.prototype.hasOwnProperty.call(singleline, 'default') ? singleline['default'] : singleline;
  ...
  */
  ...
  var MultiSelect = /*#__PURE__*/function (_React$Component) {
    ...
    _proto.render = function render() {
      ...
      }, customLabelText && React.createElement("div", {
      ...
      }, customLabelText), caretIcon && caretIcon), !customLabelText && React.createElement("div", {
        className: "rrs__label"
      }, React.createElement("span", {
        "aria-label": this.getAriaLabel(),
        className: "rrs__label__text",
      ...
      }, (prefix ? prefix + " " : '') + "\n                  " + (multiSelectSelectedOptions.options.length > 0 ? multiSelectSelectedOptions.options[0].text : '')), multiSelectSelectedOptions.options.length > 1 && React.createElement("span", {
        className: "rrs__multiselect-label__badge"
      }, "+ " + (multiSelectSelectedOptions.options.length - 1)))), caretIcon && caretIcon), name && React.createElement("input", {
        type: "hidden",
        name: name,
  ...
  var SingleSelect = /*#__PURE__*/function (_React$Component) {
    ...
    _proto.getDefaultLabel = function getDefaultLabel() {
      ...
      if (singleSelectSelectedIndex === -1) {
        return React.createElement("div", {
          ...
          id: "rrs-" + name + "-label",
          "data-testid": "rrs-label_" + name
        }, prefix && React.createElement("span", null, prefix), noSelectionLabel), caretIcon && caretIcon);
      }
      ...
      return React.createElement("div", {
        ...
        id: "rrs-" + name + "-label",
        "data-testid": "rrs-label_" + name
      }, prefix && React.createElement("span", null, prefix), singleSelectSelectedOption.text ? singleSelectSelectedOption.text : React.createElement("span", null, "\xA0")), caretIcon && caretIcon);
    };
    ...
    _proto.render = function render() {
      ...
      return React.createElement("div", null, React.createElement("div", {
        ...
        ref: this.optionsButton,
        className: singleline("\n            rrs__button\n            " + (disabled === true ? 'rrs__button--disabled' : '') + "\n          ")
      }, customLabelText ? this.getCustomLabel() : this.getDefaultLabel(), name && React.createElement("input", {
        type: "hidden",
        name: name,
        "data-testid": "rrs-input_" + name,
        ...
        return React.createElement(SingleSelectOption, {
          key: index,
          name: name,
          optHeaderLabel: optHeaderLabel,
          optionsContainerRef: _this2.optionsContainer,
  ...
  var Select = /*#__PURE__*/function (_React$Component) {
    ...
    _proto.render = function render() {
      ...
      }, !!modalCloseButton && isOptionsPanelOpen === true && React.createElement("div", {
        "aria-hidden": "true",
        className: "mobile-close"
      }, modalCloseButton), multiselect ? React.createElement(MultiSelect, {
  ...
  exports.MultiSelectOptionMarkup = MultiSelectOptionMarkup;
  exports.Select = Select;

  Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=react-responsive-select.umd.development.js.map
